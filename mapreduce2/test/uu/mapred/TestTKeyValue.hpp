/** 
 * @file TestTKeyValue.hpp
 * .
 * 
 * @author Peng Bo
 * @date 2008-04-07
 */
#ifndef _TEST_MAPREDUCE_TKEYVALUE_HPP
#define _TEST_MAPREDUCE_TKEYVALUE_HPP
...
class KeyValueFixture : public CxxTest::GlobalFixture{
    public:    
    bool setUpWorld() { 
...
static KeyValueFixture KeyValueFixture;
...
class TestTKeyValue: public CxxTest::TestSuite
{
    ...
    void doTestNormalRecordIO(bool streamType, const char* rootDirectory)
    {
        ...
        string filename = string(rootDirectory) + "/TestTKeyValue.dat";
